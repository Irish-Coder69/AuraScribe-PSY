...
' End users should run the installed Aura Scribe PSY.exe created by build_installer.ps1.
...
If Not fso.FileExists(mainPy) Then
    MsgBox "main.py was not found in this folder.", vbCritical, "Aura Scribe PSY"
    WScript.Quit 1
End If
